 ...
 * @Version: 1.0
 */
public class RocketBatchCustomer {
    ...
    public static void customer() throws MQClientException {
        DefaultMQPushConsumer consumer = new DefaultMQPushConsumer("batch_test_rocket_group");
        consumer.setNamesrvAddr("192.168.7.194:9876");
        consumer.subscribe("batch_test_topic","batch_tags_test");
